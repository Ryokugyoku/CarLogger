...
fn translate_for_language(language: Language, msgid: &str) -> &str {
    match language {
        ...
        Language::Japanese => match msgid {
            ...
            "AI condition and model management" => "AIコンディションとモデル管理",
            ...
            "Top 3 contributing signals" => "寄与上位3信号",
            "Model operations" => "モデル操作",
            "Automatic training" => "自動学習",
            "Pause training" => "学習の一時停止",
            "Training conditions" => "学習条件確認",
            "Self diagnostic" => "自己診断",
            "Restart worker" => "ワーカー再起動",
            "Reset AI data" => "AIモデルとAI派生データの初期化",
            "Current and previous models" => "現行モデル詳細・旧モデル一覧",
            "Rollback" => "ロールバック",
            "Before training" => "学習前",
            "Training" => "学習中",
            "Evaluating" => "評価中",
            "Available" => "利用可能",
            "Failed" => "失敗",
            "No AI contribution data" => "AI寄与データはありません",
            "Reset AI model and derived data?" => "AIモデルとAI派生データを初期化しますか？",
            "Only AI models and AI-derived data are deleted. Raw OBD2 logs and statistical health scores are retained. Running training blocks this operation." => {
                "AIモデルとAI派生データだけを削除します。生OBD2ログと統計健康スコアは保持します。学習実行中は初期化できません。"
            }
            "Close" => "閉じる",
